...
control_df %>% 
  ...
  view()
```
What? Seems like this didn't work at all - put people who were controls in the treatment group, people who were treated in the control group (we might expect a few of the latter, but not this many....). 
